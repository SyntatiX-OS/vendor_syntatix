...
ALARM_PATH := vendor/syntatix/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/syntatix/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/syntatix/prebuilt/common/media/audio/ringtones
